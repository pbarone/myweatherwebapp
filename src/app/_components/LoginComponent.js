...
const LoginComponent = () => {
    ...
    return (
        <div className="border rounded-md w-full max-w-sm mx-1 bg-white p-6 border-violet-600 dark:bg-gray-900" id="login-model">
            ...
            <p className="text-2xl font-bold dark:text-white text-gray-500">Login to Continue</p>
            ...
            <div className="mt-4">
                ...
                {providers && Object.values(providers).map(provider => (
                    <button type="button" 
                        ...
                        className="w-full text-center py-2 my-3 text border flex items-center justify-center border-slate-200 rounded-lg text-slate-700 hover:border-slate-400 hover:text-slate-900 hover:shadow transition duration-150">
                        Login with {provider.name} 
                    </button>
                ))}
                <a href="#" className="block no-underline font-medium">
                    <button className="w-full text-center py-2 my-3 text border flex items-center justify-center border-slate-200 rounded-lg text-slate-700 hover:border-slate-400 hover:text-slate-900 hover:shadow transition duration-150">
